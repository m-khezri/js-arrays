let elizabethSanger = {
    ...
    selectedDiv.innerHTML = stringToPrint;
     ...
     const newString = `<a href="${elizabethSanger.voterRegistrationUrl}">Registration to vote here</a>`;
     printToDom(newString, 'voterRegistration');
  };


  const donationFormStringBuilder = () => {
    const newString = `<a href="${elizabethSanger.voterRegistrationUrl}" target = "_blank"> Donate here</a>`;
